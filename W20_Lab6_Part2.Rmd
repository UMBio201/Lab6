...
# Practice
Repeat the spread + gather process to reduce the number of individuals who have paired measurements for pH and Bristol score. Calculate delta values for each of these metrics and plot them. 
```{r}
